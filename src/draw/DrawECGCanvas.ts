...
class DrawECGCanvas extends GenericCanvas {
  ...
  public draw() {
    ...
    if (
      ...
      alert(
        'AN ERROR HAS OCCURRED, THE DICOM INFORMATION IS NOT CORRECT.'
      );
    }
  }
  ...
  private buttonsEvents() {
    ...
    buttonTempoUp.addEventListener(
      'click',
      () =>
        this.changeTempo(
          true
    ...
    buttonTempoDown.addEventListener(
      'click',
      () =>
        this.changeTempo(
          false
    ...
    buttonZoomMax.addEventListener(
      'click',
      () =>
        this.changeZoom(
          false
    ...
    buttonZoomMin.addEventListener(
      'click',
      () =>
        this.changeZoom(
          true
  ...
  private drawECGIndicators() {
    ...
    let marginWidth = 10;
    this.ctx.font =
      'small-caps 800 25px Times New Roman';
    //Inicialize array:
    this.positionsDraw =
      new Array();
    //COLUMNS:
  ...
  private drawECG() {
    ...
    for (
      ...
      let startX =
        objPosition.width +
        this
          .margin; //Margin left and right to draw:
      let latestPosition =
        startY;
      ...
      //Line options:
      this.ctx.lineWidth =
        this.configuration.CURVE_WIDTH;
      this.ctx.lineCap =
        'round';
      ...
      while (
        ...
        let point =
          ...
          this
            .configuration
            .AMPLITUDE; //Rescalate. 10mV/s Each square is 1 mm.
  ...
  private ReadObjPosition(
    ...
    let code =
      this
        ...
        .ChannelLabel; //Comes in correct format split === 1
